...
![image-20200130172517596](images/image-20200130172517596.png)

### 软引用

![image-20200130172602220](images/image-20200130172602220.png)
...
public static void softRef_Memory_Enough() {
        ...
        System.out.println(o1);   
        System.out.println(softReference.get()); // 当JVM内存过小时 null
    }
```

### 弱引用

![image-20200130191459651](images/image-20200130191459651.png)

![image-20200130191534915](images/image-20200130191534915.png)
...
![image-20200130193224071](images/image-20200130193224071.png)

#### 引用队列 ReferenceQueue

![image-20200130193544505](images/image-20200130193544505.png)
...
Java提供了四种引用类型，在垃圾回收的时候，都有自己各自的特点。ReferenceQueue是用来配合引用工作的，没有ReferenceQueue一样可以运行。
...
![image-20200130195043053](images/image-20200130195043053.png)
...
超过98％的时间用来做GC但是回收了不到2％的堆内存

-Xms10m -Xmx10m -XX:+PrintGCDetails -XX:MaxDirectMemorySize=5m

### java.lang.OutOfMemoryError: Direct buffer memory

![image-20200131114348789](images/image-20200131114348789.png)

![image-20200131114409898](images/image-20200131114409898.png)

### java.lang.OutOfMemoryError: Unable to create new native method

![image-20200131144043155](images/image-20200131144043155.png)



![image-20200131144051156](images/image-20200131144051156.png)



### Java.lang.OutOfMemeoryError:Metaspace

![image-20200131144227347](images/image-20200131144227347.png)

## 回收器

![image-20200131144648496](images/image-20200131144648496.png)
...
![image-20200131190842968](images/image-20200131190842968.png)
